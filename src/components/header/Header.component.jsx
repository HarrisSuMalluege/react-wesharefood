...
const RenderHeader = ({ userID, name, profileImg }) => (
    ...
    <div className="header">
        ...
        <nav className="user-nav">
            <div className="user-nav__icon-box">
                <Icon name="bookmarks" width={32} fill="true" className='user-nav__icon' />
                <span className="user-nav__notification">6</span>
            </div>
            <div className="user-nav__icon-box">
                <Icon name="bubbles" width={32} fill="true" className='user-nav__icon' />
